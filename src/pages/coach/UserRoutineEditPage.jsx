            ...
            <article className='row justify-content-center'>
                ...
                <button onClick={createWeek} className='input-group-text btn BlackBGtextWhite text-center' >Crear semana <b className='fs-6'>{weekNumber}</b></button>
                    ...
                    <div className='mt-3 col-8'> 
                        <InputSwitch className='custom' checked={copyWeek} onChange={(e) => setCopyWeek(e.value)} />

                    </div>
                    <div className='col-4' tooltip="Copiar automaticamente una plantilla de la última semana. ¡Podés desactivarla en cualquier momento y crear una semana de 0!" tooltipOptions={{ position: 'bottom', mouseTrack: true, mouseTrackTop: 15, style: {width: 20 + 'em'} }}>
