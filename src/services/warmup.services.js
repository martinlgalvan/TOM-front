async function findWarmup(week_id, warmup_id) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/warmup/${warmup_id}`, {
        method: 'GET',
        headers: {
...
async function createWarmup(week_id, day_id, warmup) {
  return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}/warmup`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
          'auth-token': localStorage.getItem('token')
...
async function editWarmup(week_id, day_id, warmup_id, warmup) {
  return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}/warmup/${warmup_id}`, {
      method: 'PUT',
      headers: {
          'Content-Type': 'application/json',
          'auth-token': localStorage.getItem('token')
