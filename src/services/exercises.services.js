...
async function findExercises(id) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/day/${id}/exercise`, {
        method: 'GET',
        headers: {
...
async function addExerciseToDay(week_id,day_id, exercise) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}/exercises`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function addAmrap(week_id,day_id, amrap) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}/exercises/amrap`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function editExerciseAmrap(week_id,day_id,exercise_id, amrap) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}/exercise/${exercise_id}/amrap`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function deleteExercise(week_id, day_id, exercise_id) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}/exercise/${exercise_id}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
