...
async function addAmrap(week_id,day_id, amrap) {
    return fetch(`httpS://tom-api.vercel.app/api/week/${week_id}/day/${day_id}/exercises/amrap`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function editExerciseAmrap(week_id,day_id,exercise_id, amrap) {
    return fetch(`httpS://tom-api.vercel.app/api/week/${week_id}/day/${day_id}/exercise/${exercise_id}/amrap`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
