...
async function find(id) {
    return fetch(`http://tom-api-serverless.vercel.app/api/users/${id}`, {
        method: 'GET',
        headers: {
...
async function deleteUser(id) {
    return fetch(`http://tom-api-serverless.vercel.app/api/user/${id}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function findDays(id) {
    return fetch(`http://tom-api-serverless.vercel.app/api/users/routine/${id}/createDay`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function deleteExercise(idDay, idExercise) {
    return fetch(`http://tom-api-serverless.vercel.app/api/day/${idDay}/exercise/${idExercise}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function findRoutineById(id) {
    return fetch(`http://tom-api-serverless.vercel.app/api/user/${id}/routine`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
