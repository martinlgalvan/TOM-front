...
async function findRoutineByUserId(user_id) {
    return fetch(`https://tom-api-git-main-martinlgalvan.vercel.app/api/user/${user_id}/routine`, {
        method: 'GET',
        headers: {
...
async function createClonWeek(user_id) {
    return fetch(`https://tom-api-git-main-martinlgalvan.vercel.app/api/user/${user_id}/routine/clon`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
...
async function findByWeekId(week_id) {
    return fetch(`https://tom-api-git-main-martinlgalvan.vercel.app/api/week/${week_id}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
