...
async function createDay(name, week_id) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day`, {
        method: 'POST',
        headers: {
...
async function editDay(week_id, day_id, name) {
    return fetch(`https://tom-api-martinlgalvan.vercel.app/api/week/${week_id}/day/${day_id}`, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token')
