...
function App(){
    ...
    */
    ...
    return (
        ...
        <nav className={`navbar navbar-expand-lg ${!textColor ? "bbb" : "text-light"}`} style={{ "backgroundColor": `black` }} >
        ...
        <footer className={`container-fluid ${!textColor ? "bbb" : "blackColor"}`} style={{ "backgroundColor": `black` }} >
            <div className="row">
                <ul className="text-center ">
                    ...
                    <li className="mt-4"><a target="_blank" href="https://wa.me/message/6PSH46QCW4OTP1" className=""><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
