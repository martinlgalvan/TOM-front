    ...
    return (
        ...
        <nav className={`navbar navbar-expand-lg navbar-dark fixed-top ${textColor == 'false' || !textColor ? "bbb" : "blackColor"}`} style={{ "backgroundColor": `${color}` }} >
            ...
            <div className="container-fluid ">
                ...
                <div className="collapse navbar-collapse justify-content-end  " id="navbarNav">
                    <ul className="navbar-nav text-center ">
                        ...
                        <li className="nav-item">
                        {!isAutenticated && <><Link className={`nav-link ${location.pathname == `/login` && 'active'}`} to={"/login"}>Iniciar sesión</Link> </>}
                        </li>
                        <li className="nav-item">
            ...
            {isAdmin() && (
              <div className="row justify-content-center text-center">
                <Link
                  className={` col-10 ${location.pathname === `/users/${id}` && 'active'}`}
                  to={`/users/${id}`}
                ...
                <span className='col-10 text-light'>Alumnos</span>
              </div>
            )}
            ...
            {isAdmin() && (
              <div className="row justify-content-center text-center">
                <Link
                  className={`col-10 ${location.pathname === '/novedades/' && 'active'}`}
                  to="/novedades/"
                  onClick={() => setMenuSidebar(false)}
                >
                  <IconButton className="buttonsNav">
                    <ArticleIcon />
                  </IconButton>
                </Link>
                <span className='col-10 text-light'>Novedades</span>
              </div>
            )}
            ...
            {isAdmin() && (
              <div className="row justify-content-center text-center">
                <Link
                  className={`col-10 ${location.pathname === '/personalize/' && 'active'}`}
                  to="/personalize/"
                  onClick={() => setMenuSidebar(false)}
                >
                  <IconButton className="buttonsNav">
                ...
                <span className='col-10 text-light'>Perfil</span>
              </div>
            )}
            ...
            {isAdmin() && (
              <div className="row justify-content-center text-center">
                <Link
                  className={`col-10 ${location.pathname === `/planificator/${id}` && 'active'}`}
                  to={`/planificator/${id}`}
                  onClick={() => setMenuSidebar(false)}
                >
                  <IconButton className="buttonsNav">
                ...
                <span className='col-10 text-light'>Planificador</span>
              </div>
            )}
            ...
            {isAutenticated && !isAdmin() && (
              <div className="row justify-content-center text-center">
                <Link
                  className={`col-10 ${location.pathname === `/perfil/${id}/` && 'active'}`}
                  to={`/perfil/${id}`}
                  onClick={() => setMenuSidebar(false)}
                >
                  <IconButton className="buttonsNav">
            ...
            {isAutenticated && !isAdmin() && (
              <div className="row justify-content-center text-center">
                <Link
                  className={`col-10 ${location.pathname === `/routine/${id}/` && 'active'}`}
                  to={`/routine/${id}`}
                  onClick={() => setMenuSidebar(false)}
                >
                  <IconButton className="buttonsNav">
                ...
                <span className='col-10 text-light'>Ver rutina</span>
              </div>
            )}
            ...
            {!isAutenticated && (
              <div className="row justify-content-center text-center">
                <Link
                  className={`col-10 ${location.pathname === '/login/' && 'active'}`}
                  to="/login"
                  onClick={() => setMenuSidebar(false)}
                >
                  <IconButton className="buttonsNav">
                ...
                <span className='col-10 text-light'>Iniciar sesión</span>
              </div>
            )}
        ...
        <footer className={`container-fluid ${textColor == 'false' || !textColor ? "bbb" : "blackColor"}`} style={{ "backgroundColor": `${color}` }} >
            <div className="row">
                ...
                <p className={`text-center mt-3  ${location.pathname != '/' && 'pb-5 mb-5'}`}>&copy; 2022 | TOM </p>
            </div>
        </footer>
        ...
        <Dialog
                        ...
                        onHide={() => setOpenDialogLogout(false)} // Cerrar el popup si se cancela
                    >
