                         ...
                         >
                            ...
                            <td>
                              {inputEnFoco == null ?
                                ...
                                <button disabled={inputEnFoco !== null && inputEnFoco !== index} onClick={(e) => editWarmup(warmup_id, newName == undefined ? name : newName, newSet == undefined ? sets : newRep, reps == undefined ? reps : newRep, peso == undefined ? peso : newPeso, video == undefined ? video : newVideo, notas == undefined ? notas : newNotas, numberWarmup)} className='btn buttonsEdit'>
