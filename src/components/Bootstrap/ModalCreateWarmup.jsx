                    ...
                    <table className="table align-middle table-bordered caption-top">
                        ...
                        {warmup != null && warmup.map((elemento, index) =>
                         ...
                         >
                            ...
                            <td>
                                <button disabled={inputEnFoco !== null && inputEnFoco !== index} onClick={(e) => editWarmup(elemento.warmup_id, name == undefined ? name : name, sets == undefined ? sets : sets, reps == undefined ? reps : reps, peso == undefined ? peso : peso, video == undefined ? video : video, notas == undefined ? notas : notas, numberExercise, valueExercise)} className='btn buttonsEdit'>
