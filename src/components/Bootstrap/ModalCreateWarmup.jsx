            ...
            <form className="row justify-content-center align-items-center" onSubmit={onSubmit}>
              ...
              <div className="col-10 col-xl-6 my-3">
                <span className="p-float-label p-fluid">
                  <AutoComplete inputRef={refAutocomplete} appendTo={null} inputClassName={"rounded-0 w-100"} field="name" value={selectedExercise} suggestions={filteredExercises} completeMethod={search} onChange={(e) => setSelectedExercise(e.value)} />    
